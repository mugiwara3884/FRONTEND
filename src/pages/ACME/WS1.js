      ...
      <Stack style={{marginTop:"-19px"}}>
            ...
            <BlockHeadContent>
              <div className="toggle-wrap nk-block-tools-toggle">
                ...
                <div
                  ...
                  style={{ display: sm ? "block" : "none" ,marginRight:"-160px"}}
        ...
        <Block>
          <DataTable className="card-stretch">
            ...
            <DataTableBody>
              <DataTableHead>
                <DataTableRow>
                  <span className="sub-text" style={{fontWeight:"bold"}}>Name</span>
                </DataTableRow>
                {/* <DataTableRow size="md">
                  <span className="sub-text">Path</span>
                </DataTableRow> */}
                <DataTableRow size="lg">
                  <span className="sub-text" style={{fontWeight:"bold"}}>Modified</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text" style={{fontWeight:"bold"}}>Modified By</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text" style={{fontWeight:"bold"}}>File Size</span>
                </DataTableRow>
                <DataTableRow size="lg">
                  <span className="sub-text" style={{fontWeight:"bold"}}>Sharing</span>
                </DataTableRow>
        ...
        >
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">
                {editId ? "Update Folfer" : "Create Folder"}
              </h5>
              <div className="mt-4" >
                <Form
                  className="row gy-4"
                  ...
                  <Col md="12">
                    <FormGroup>
                      ...
                      <input
                        ...
                        type="text"
                        name="folder_name"
                        defaultValue={formData.folder_name}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
